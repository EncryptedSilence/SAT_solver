...
# Allow running directly via `python examples/best_trail_c0_1_10_15.py`.
...
assert len(AES_SBOX) == 256 and len(set(AES_SBOX)) == 256
...
def main() -> None:
    print(f"Target: lin344, c0={C0}, R={ROUNDS}, AES S-box")
    ...
    # Lower bound: 9 active S-boxes (known for c0=(1,10,15), R=3) times 6.
    # Upper bound: 9 * 7 = 63.
    w_lo = 6 * 9  # 54
    w_hi = 7 * 9  # 63
